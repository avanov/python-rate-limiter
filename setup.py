...
setup(name='python-rate-limiter',
      version='0.0.1',
      description='Redis-based Python rate-limiter with bucketing',
      ...
      url='https://github.com/avanov/python-rate-limiter',
      keywords='utils rate-limiter',
